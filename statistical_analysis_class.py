...
class StatisticalAnalysis(GeneExpressionData):
    ...
    def __init__(self, gene_expression_data, expression_values1, expression_values2, top_n):
        ...
        self.calculate_differential_expression()
    ...
    def calculate_differential_expression(self):
        ...
        for _, (tissue_type, expression_data) in self.expression_dict.items():
            ...
            for gene_name, expression in zip(self.gene_list, expression_data):
                ...
                # commandline
                if tissue_type == self.expression_values1:
                ...
                elif tissue_type == self.expression_values2:
        ...
        self.top_n_upregulated_genes = sorted(
            differential_dict.items(), key=lambda item: item[1], reverse=True)[:self.top_n]
        ...
        self.top_n_downregulated_genes = sorted(
            differential_dict.items(), key=lambda item: item[1], reverse=False)[:self.top_n]
