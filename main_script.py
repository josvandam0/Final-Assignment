...
from barplot import BarPlotCreator
...
def main():
    ...
    parser.add_argument("--exp-val1", required=True,
                        help="Please enter the first tissue type you want to compare the second to")
    parser.add_argument("--exp-val2", required=True,
    ...
    # class
    analysis = StatisticalAnalysis(expression_data)
    ...
    analysis.calculate_differential_expression(args.exp_val1, args.exp_val2, args.top_n)
    ...
    barplot_creator = BarPlotCreator(analysis, args.exp_val1, args.exp_val2, args.top_n)

    barplot_creator.confidence_interval()

    # creating barplots with the specific tissue types
    # and differential expression of the tissue types
    # that have been parsed through in the commandline

    barplot_creator.create_barplot()
